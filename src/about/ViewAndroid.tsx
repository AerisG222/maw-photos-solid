...
const ViewApplication: Component = () => {
    return (
        <>
            ...
            <p class="text-center m-y-6">
                <a target="_blank" href="https://play.google.com/store/apps/details?id=us.mikeandwan.pictures">
                    <img class="inline" src="/icon.svg" class="w-[72px] h-[72px] saturate-50 hover:saturate-100" />
                </a>
            </p>
        </>
    );
