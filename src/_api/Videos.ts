...
export const getRating = (videoId: number) => queryMawApi<Rating>(`videos/${videoId}/rating`);
...
export const getGpsDetail = (videoId: number) => queryMawApi<ApiGpsDetail>(`videos/${videoId}/gps`);
